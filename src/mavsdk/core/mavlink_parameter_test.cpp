...
TEST(MavlinkParameterSet, SimpleTest)
{
    ...
    EXPECT_EQ(
        MavlinkParameterSet::UpdateExistingParamResult::SUCCESS,
        mavlink_parameter_set.update_existing_parameter(int_value1.id, int_value1.value));
    // haven't added it yet
    EXPECT_EQ(
        MavlinkParameterSet::UpdateExistingParamResult::MISSING_PARAM,
        mavlink_parameter_set.update_existing_parameter(custom_value1.id, custom_value1.value));
    ...
    EXPECT_EQ(
        MavlinkParameterSet::UpdateExistingParamResult::WRONG_PARAM_TYPE,
        mavlink_parameter_set.update_existing_parameter(custom_value1.id, int_value1.value));
}
